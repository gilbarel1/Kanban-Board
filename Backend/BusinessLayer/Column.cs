...
namespace IntroSE.Kanban.Backend.BusinessLayer
{
    public class Column
    {
        ...
        internal Column(string title, int columnOrdinal, long boardId)
        {
            this.title = title;
            tasks = new List<Task>();
        ...
        internal Column(string title, int columnOrdinal, long boardId, int limit)
        {
            this.title = title;
            tasks = new List<Task>();
            this.limit = limit;
        ...
        public void LoadTasks(long boardId, int columnOrdinal)
        {
        ...
        internal void DeleteTasks(int ordinal, long boardId)
        {
