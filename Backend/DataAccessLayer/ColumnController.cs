...
namespace IntroSE.Kanban.Backend.DataAccessLayer
{
    internal class ColumnController
    {
        ...
        public bool Update(long boardId,int columnOrdinal, string attributeName, string attributeValue)
        {
            int res = -1;
            using (var connection = new SQLiteConnection(_connectionString))
            {
        ...
        /// <param name="attributeValue"></param>
        /// <returns> boolean value whether the update action has succeeded </returns>
        public bool Update(long boardId, int columnOrdinal, string attributeName, long attributeValue)
        {
            int res = -1;
            using (var connection = new SQLiteConnection(_connectionString))
            {
        ...
        /// <exception cref="ArgumentException"></exception>
        internal List<ColumnDTO> LoadBoardColumns(long boardId)
        {
        ...
        {
            return new ColumnDTO((long)reader.GetInt64(1),reader.GetString(0), (int)reader.GetInt32(3),(int)reader.GetInt32(2));
        }
